  ...
  const cardsData = [
    {
      ...
      },
      {
        id: 15,
        title: "Мерия [ 15 -> 16 ]",
        description: "<b>Условия улучшения:</b> Стена [15 lvl] + Железный рудник [15 lvl]. <br><b>Ресурсы на улучшения мэрии:</b> Провизия и Нефть 5,181,790 + Железо 518,180. <br><b>Ресурсы на улучшения стены:</b> Нефть 4,082,420.",
        image: "https://vipersmax.github.io/AOO-EVENTS-CALENDAR/img/none.png",
      },
      {
        id: 16,
