...
const cards = [
  ...
  },
  {
    ...
    description: "Нужно захватывать бащни и столицу мира. Побеждает тот альянс, кто наберет большее количество очков.",
    baseDate: new Date("2024-11-16T00:21:00+00:00").getTime(), // Индивидуальная базовая дата
