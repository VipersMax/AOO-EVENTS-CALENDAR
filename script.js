...
const cards = [
  ...
  },
  {
    ...
    description: "Начало битвы между серверами.",
  ...
  },
  {
    ...
    title: "Сброс счетчика в `Бесконечная орда зомби`",
    description: "В режиме `бесконечная орда зомби` сбрасываются набранные очки и нужно снова в пройти уровень в ручном режиме.",
    baseDate: new Date("2024-11-15T00:00:00+00:00").getTime(), // Индивидуальная базовая дата
    duration: 7 * 24 * 60 * 60 * 1000, // Повторение раз в неделю
    activePeriod: 1 * 24 * 60 * 60 * 1000, // Длительность 1 день
  },
