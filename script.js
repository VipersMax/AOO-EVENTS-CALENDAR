...
const cards = [
  ...
  },
  {
    ...
    title: "Путь легенды",
    description: "Выполняй задания каждый день и получай очки, которые открывают призы. <br>Задания: Набрать 60/100/150/240/360 очков в ежедневных заданиях; Принять участие в бесконечном режиме, Купить на складе 5/10 ресурсов; Сделать 1 покупку на бирже Бесконечного режима.",
  ...
  },
  {
    ...
    duration: 7 * 24 * 60 * 60 * 1000, // Повторение раз в неделю
    activePeriod: 2 * 24 * 60 * 60 * 1000, // Длительность 2 дня
  },
  {
    id: 5,
  ...
  },
  {
    ...
    baseDate: new Date("2024-11-11T00:00:00+00:00").getTime(), // Индивидуальная базовая дата
    duration: 28 * 24 * 60 * 60 * 1000, // Повторение раз 28 дней
  ...
  },
  {
    ...
    duration: 28 * 24 * 60 * 60 * 1000, // Повторение раз в 2 недели
  ...
  },
  {
    ...
    duration: 7 * 24 * 60 * 60 * 1000, // Повторение раз в 28 дней
    // ПОВТОРЫ:
  ...
  },
  {
    ...
    duration: 28 * 24 * 60 * 60 * 1000, // Повторение раз в 28 дней
    activePeriod: 1 * 24 * 60 * 60 * 1000, // Длительность 1 день
  },
  {
    id: 13,
  ...
  },
  {
    ...
    description: "Улучшай машину (улучшения берутся в ивенте `Тренировочный заезд`), уклоняйся на ней от препятствий, набирай очки и получай за них награды.",
  ...
  },
  {
    ...
    description: "Дополнение к ивенту `Дикие гонки (В команде)`. Нужно дляя получения деталей к машине. <br>Задания: 1 день: Потратить 5/15/20 жидкости модификаций; Использовать мяса мутантов на 5к/10к/25к опыта; Ипользовать 10/20/35 банок с энергией титана. <br>2 день: Завербовать 5/9/18 элитных офицеров; Потратить 5к/15к/20к опыта офицеров; Потратить 200/350/500 опыта навыка офицера. <br>3 день: ждем",
    baseDate: new Date("2024-11-20T00:00:00+00:00").getTime(), // Индивидуальная базовая дата
    duration: 28 * 24 * 60 * 60 * 1000, // Повторение раз 28 дней
  ...
  {
    id: 16,
    image: "https://vipersmax.github.io/AOO-EVENTS-CALENDAR/img/16.png",
    title: "Битва за город",
    description: "Игроки альянсов захватывают башни на карте мира, после чего участники из топ-5 альянсов по захваченным очкам получают награды в виде RSS.",
    baseDate: new Date("2024-11-20T00:11:00+00:00").getTime(), // Индивидуальная базовая дата
    duration: 7 * 24 * 60 * 60 * 1000, // Повторение раз в 7 дней
    activePeriod: 3 * 60 * 60 * 1000, // Длительность 3 часа
  },
  {
    id: 17,
  ...
  },
  {
    id: 18,
    image: "https://vipersmax.github.io/AOO-EVENTS-CALENDAR/img/none.png",
    title: "Клуб искателей сокровищ",
    description: "Выполняй ежедневные задания ивента, получай инструменты для вскапывания, выкапывай награды. <br>Задания: Зайти в игру; Иследовать руины 2 раза; Убить 5 зомби; Исспользовать 200 минут ускорения; Купить пакеты 1 раз. Сделать 15 вкладов в альянс; Купить ресурсы 10 раз на распродаже; Обработать 20 материалов.",
    baseDate: new Date("2024-11-22T00:00:00+00:00").getTime(), // Индивидуальная базовая дата
    duration: 14 * 24 * 60 * 60 * 1000, // Повторение раз в 14 дней
    activePeriod: 3 * 24 * 60 * 60 * 1000, // Длительность 3 дня
  },
];
